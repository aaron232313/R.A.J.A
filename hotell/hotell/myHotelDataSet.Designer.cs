...
namespace hotell.myHotelDataSetTableAdapters {
    ...
    public partial class roomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[rooms] WHERE (([roomid] = @Original_roomid) AND ([roomNo] = @Original_roomNo) AND ([roomType] = @Original_roomType) AND ([roomstatus] = @Original_roomstatus) AND ([price] = @Original_price) AND ((@IsNull_booked = 1 AND [booked] IS NULL) OR ([booked] = @Original_booked)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[rooms] SET [roomNo] = @roomNo, [roomType] = @roomType, [roomstatus] = @roomstatus, [price] = @price, [booked] = @booked WHERE (([roomid] = @Original_roomid) AND ([roomNo] = @Original_roomNo) AND ([roomType] = @Original_roomType) AND ([roomstatus] = @Original_roomstatus) AND ([price] = @Original_price) AND ((@IsNull_booked = 1 AND [booked] IS NULL) OR ([booked] = @Original_booked)));
SELECT roomid, roomNo, roomType, roomstatus, price, booked FROM rooms WHERE (roomid = @roomid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::hotell.Properties.Settings.Default.myHotelConnectionString;
        }
